export default function RecentEvents() {
  return (
    <div className="flex flex-col rounded-2xl border border-slate-200 bg-surface-light p-6 dark:border-white/5 dark:bg-surface-dark">
      <h4 className="mb-6 text-lg font-bold text-slate-800 dark:text-white">Recent Events</h4>
      <div className="flex-1 space-y-6">
        <div className="flex items-start gap-4">
          <div className="flex size-12 flex-col items-center justify-center rounded-xl bg-primary/10 font-bold text-primary dark:bg-white/5">
            <span className="text-[10px] leading-none opacity-70">OCT</span>
            <span className="text-lg leading-none">24</span>
          </div>
          <div className="flex-1">
            <h5 className="text-sm font-bold text-slate-700 dark:text-slate-300">University Intramurals 2024</h5>
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h5 className="text-sm font-bold text-slate-700 dark:text-slate-300">Student General Assembly</h5>
        ...
        <div className="flex items-start gap-4 opacity-60">
          <div className="flex size-12 flex-col items-center justify-center rounded-xl bg-slate-100 font-bold text-slate-400 dark:bg-white/5">
            <span className="text-[10px] leading-none opacity-70">OCT</span>
            <span className="text-lg leading-none">15</span>
          </div>
          <div className="flex-1">
            <h5 className="text-sm font-bold text-slate-700 dark:text-slate-300">Leadership Training Seminar</h5>
