...
export default function ImportInformation({ tenantPlan }: Props) {
  return (
    <div className="mb-10 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
      <div className="flex items-start gap-4 rounded-xl border border-slate-200 bg-surface-light p-4 dark:border-white/5 dark:bg-surface-dark">
        <div className="mt-1 text-primary">
          <span className="material-symbols-outlined">info</span>
        </div>
        <div>
          <p className="text-sm font-bold text-slate-600 dark:text-white">Avoid Duplicates</p>
      ...
      <div className="flex items-start gap-4 rounded-xl border border-slate-200 bg-surface-light p-4 dark:border-white/5 dark:bg-surface-dark">
        ...
        <div>
          <p className="text-sm font-bold text-slate-600 dark:text-white">Validation Check</p>
      ...
      <div className="flex items-start gap-4 rounded-xl border border-slate-200 bg-surface-light p-4 dark:border-white/5 dark:bg-surface-dark">
        ...
        <div>
          <p className="text-sm font-bold text-slate-600 dark:text-white">Data Privacy</p>
      ...
      <div className="flex items-start gap-4 rounded-xl border border-slate-200 bg-surface-light p-4 dark:border-white/5 dark:bg-surface-dark">
        ...
        <div>
          <p className="text-sm font-bold text-slate-600 dark:text-white">Plan Limits</p>
