    ...
    <div className="mt-auto p-4">
      {isPremium ? (
        ...
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-white/5">
          ...
          <button className="w-full rounded-lg bg-slate-200 py-2 text-xs font-bold text-slate-700 transition-all hover:bg-slate-300 dark:bg-white/10 dark:text-white dark:hover:bg-white/20">UPGRADE TO PREMIUM</button>
        </div>
      )}
    </div>
  );
