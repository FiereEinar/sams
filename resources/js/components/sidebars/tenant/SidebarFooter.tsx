    ...
    <div className="mt-auto p-4">
      {isPremium ? (
        <div className="rounded-2xl border border-primary/20 bg-primary/10 p-4">
          ...
          <Link href="/settings?tab=plan" className="block w-full rounded-lg bg-primary py-2 text-center text-xs font-bold text-white transition-all hover:bg-primary-hover">MANAGE PLAN</Link>
        </div>
      ) : (
        <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-white/10 dark:bg-white/5">
          ...
          <Link href="/settings?tab=plan" className="block w-full rounded-lg bg-slate-200 py-2 text-center text-xs font-bold text-slate-700 transition-all hover:bg-slate-300 dark:bg-white/10 dark:text-white dark:hover:bg-white/20">UPGRADE TO PREMIUM</Link>
        </div>
      )}
    </div>
  );
